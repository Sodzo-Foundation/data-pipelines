# USAGE
# python load_and_visualize.py --dataset dataset/pollutants
# python load_and_visualize.py --dataset dataset/pollutants --aug 1 --type layers
# python load_and_visualize.py --dataset dataset/pollutants --aug 1 --type ops
